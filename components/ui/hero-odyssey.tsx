      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
        ...
        >
          <div className="flex items-center">
            <div className="text-2xl font-bold tracking-widest uppercase">Ink Nation</div>
            <div className="hidden md:flex items-center space-x-6 ml-8">
              <button className="px-4 py-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-full text-sm transition-colors">Studio</button>
              <button className="px-4 py-2 text-sm hover:text-gray-300 transition-colors">Artists</button>
              <button className="px-4 py-2 text-sm hover:text-gray-300 transition-colors">Gallery</button>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="px-4 py-2 bg-gray-800/80 backdrop-blur-sm rounded-full text-sm hover:bg-gray-700/80 transition-colors">Book a Session</button>
            <button className="md:hidden p-2 rounded-md focus:outline-none" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
              {mobileMenuOpen
